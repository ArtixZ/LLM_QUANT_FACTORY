        ...
        record["metrics"].update(
            {
                ...
                "long_only_capacity_usd": 80_000_000,
                ...
                "long_only_walk_forward_positive_fraction": 0.8,
                    ...
                    "recent_long_only_capacity_usd": 70_000_000,
...
def test_library_default_ranking_uses_recent_long_only_as_tie_breaker() -> None:
    ...
    common_long_only = {
        ...
        "long_only_capacity_usd": 70_000_000,
    ...
    legacy_strong["metrics"].update(
        {
            **common_long_only,
            ...
            "recent_long_only_capacity_usd": 10_000_000,
    ...
    recent_strong["metrics"].update(
        {
            **common_long_only,
            ...
            "recent_long_only_capacity_usd": 90_000_000,
